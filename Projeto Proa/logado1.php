...
<html lang="pt-br" dir="ltr">
  ...
  <body>
    ...
    <li id="lilog"><?php session_start(); echo('<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
         ...
         <li class="hvr-grow"><a href="#"><button type="button" class="btn cor1">Ajude a Amazônia</button></a></li>       
        </ul>
    </nav>
        <main>
        <header>
                <div class="sec1" id="div2">
                        <div class="cor1">
                          <br>
                        <h1 class="display-4 letra">Consciência ambiental</h1>
                        <br>
                        <p class="lead letra">Esta página se dedica a concentrar e organizar, de forma
                          dinâmica e didática, diversos conteúdos acerca da esfera ambiental,
                          visando incentivar o já crescente ciberativismo ambientalista no Brasil.
                  ...
                  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      ...
                      <div class="carousel-item">
                        <a href="https://g1.globo.com/natureza/aquecimento-global/noticia/2020/11/12/duracao-de-furacoes-aumenta-com-aquecimento-global-sugere-estudo-publicado-na-nature.ghtml" target="black"><img src="imagens/furacão.jpg" class="d-block w-100 img56" alt="..."></a>
                        <div class="carousel-caption d-none d-md-block">
                          <h5 style="color: rgb(255, 255, 255)">Duração de furacões aumenta com aquecimento global</h5>
                      ...
                      <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block" >
                          <h5>Mudança climática causa desertificação</h5>
                          <p>Clique na imagem para saber mais</p>
                        </div>
                      </div>
                    </div>
        ...
        <section class="cor1">
              ...
              <div class="text">Mudança climática: as imagens impressionantes de geleiras derretendo na China</div>
              <div class="btn">
              ...
              <div class="top-text">
              <div class="name">Última girafa branca do mundo</div>
                <p>Animal em extinção</p>
              </div>
              <div class="bottom-text">
              <div class="text">Espécime macho é a única restante de um trio portador do raro traço genético, depois que uma fêmea branca e o filhote dela foram mortos por caçadores ilegais no Quênia.</div>
              <div class="btn">
              ...
              <div class="top-text">
              <div class="name">Corredores Ecológicos</div>
                <p>Preservação do meio ambiente</p>
              </div>
              <div class="bottom-text">
              <div class="text">Projeto Corredores Ecológicos restaura paisagens, beneficia animais </div>
              <div class="btn">
         ...
         <section class="cor1">
           <!-- Card 1 -->
              ...
              <div class="top-text">
              <div class="name">Desmatamento em Rondônia</div>
                 <p>Desmatamento</p>
              </div>
              <div class="bottom-text">
              <div class="text">Rondônia tem aumento de 88% nos alertas de desmatamento em outubro, revela Imazon</div>
              <div class="btn">
              ...
              <div class="top-text">
              <div class="name">França quer punir delito de 'ecocídio'</div>
                 <p>Emissão de carbono na atmosfera </p>
              </div>
              <div class="bottom-text">
              <div class="text">Proposta apoiada pelo governo prevê pena de até dez anos de prisão e multa de até 4,5 milhões de euros para quem causar danos graves ao meio ambiente.</div>
               <div class="btn">
        ...
        <section class="cor1">   
          ...
          <section class="cor1">
            <div class="container">
              ...
              <div class="card">
                ...
                <div class="name">Ecobags</div>
                      <p>Qual a importância das sacolas ecológicas ?</p>
                </div>
                <div class="bottom-text">
                <div class="text">Ecobags são produtos criados para substituir a utilização das sacolas de plástico em favor do meio ambiente.</div>
                <div class="btn">
                ...
                <div class="top-text">
                 <div class="name">Separação do Lixo</div>
                    <p>Por que é tão importante separar o lixo ?</p>
                </div>
                <div class="bottom-text">
                <div class="text">A reciclagem de lixo no Brasil ainda é bastante deficiente e precária devido a falta de empresas especializadas em coleta seletiva.</div>
                <div class="btn">
                ...
                <div class="bottom-text">
                <div class="text">O óleo de cozinha usado pode parecer inocente, mas é um grande contaminante. Um litro de óleo descartado no ralo da pia pode poluir um milhão de litros de água potável.</div>
                <div class="btn">
            ...
            <!-- cards -->
                  ...
                  <div class="top-text">
                  <div class="name">Horta Sustentável</div>
                      <p>Importância da horta na escola</p>
                  </div>
                  <div class="bottom-text">
                  <div class="text">Uma horta na escola funciona como um ótimo recurso didático. São diversos benefícios que esse tipo de projeto pode proporcionar.</div>
                  <div class="btn">
                  ...
                  <div class="bottom-text">
                  <div class="text"> Vistas como um grande problema, as embalagens PET também podem ser uma grande solução. Com criatividade e um pouco de esforço, esse plástico pode ser reaproveitado de inúmeras maneiras.</div>
                  <div class="btn">
                  ...
                  <div class="bottom-text">
                  <div class="text">Você sabe o que fazer com aquele pneu gasto, careca, que não vai usar mais? Descartar em qualquer lugar ou deixar em casa acumulando poeira ou, pior ainda, água não é uma boa ideia. Então, que tal se inspirar em alguns bons exemplos de reuso desse item? Confira nossas dicas e modelos de artesanato com pneus!</div>
                  <div class="btn">
            ...
            <div class="row">
              ...
              <div class="col-xs-6 col-md-3" id="linksfooter">
                              ...
                              <ul class="footer-links" >
                                ...
                                <br>
                                <li><a href="#"><button type="button" class="btn btn-success">Ajude a Amazônia</button></a></li>
                                <br>
