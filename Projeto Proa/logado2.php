          ...
          <!-- header -->
            <header>
                <div class="sec1" id="div2">
                        <div class="cor1 t1">
                            <h1 class="display-4 letra" style="font-size: 45px;">PANTHERA ONÇA</h1>
                          <br>
                          <div class="sec1">
                            <p class="lead letra">A Onça-Pintada, também chamada de Jaguar, é o maior felino das Américas e o terceiro maior do mundo, depois dos tigres e dos leões.Felino de grande porte, o jaguar é um exímio predador carnívoro.
                            <br><br>  
                            Sua alimentação é bem variada e envolve mais de 80 espécies diferentes, incluindo cobras, jacarés, peixes, macacos, répteis, anfíbios e gado bovino. O felino pode comer até 20 kg de carne em um mesmo dia, para em seguida ficar uma semana sem se alimentar novamente.</p>
                          </div>
                        </div>
                        <div id="div1">
                    ...
                    <div class="jumbotron">
                        <div class="container">
                            ...
                            <div>
                                ...
                                <p class="lead">O projeto Vida Terrestre é composto por uma equipe de 6 membros. A plataforma foi criada com a finalidade
                                  de conscientizar e expandir os conhecimentos dos usuários e visitantes sobre questões ambientais, com uma linguagem comum e menos técnica, a fim de facilitar a compreensão do público leigo.
                                  Temos o objetivo de motivar as pessoas a terem responsabilidade e cuidado com o nosso lar, a Terra. Sempre com Respeito e Ética.</p>
                            </div>    
                        </div>
                      </div>
                </section>
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-6 col-md-3" id="linksfooter">
                              ...
                              <ul class="footer-links" >
                                <li><a href="logado1.php"><button type="button" class="btn btn-success">Início</button></a></li>
                                <br>
